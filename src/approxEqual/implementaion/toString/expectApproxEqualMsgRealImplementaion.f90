...
contains
    ...
    !>
    module procedure expect_approx_equal_real32_msg
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real64_msg
        use :: fassert_common_compare_approx_real
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real128_msg
        use :: fassert_common_compare_approx_real
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real32_rank1_msg
        use :: expectSameShape
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real32_rank2_msg
        use :: expectSameShape
        use :: fassert_common_compare_approx_array
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real32_rank3_msg
        use :: expectSameShape
        use :: fassert_common_compare_approx_array
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real64_rank1_msg
        use :: expectSameShape
        use :: fassert_common_compare_approx_array
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real64_rank2_msg
        use :: expectSameShape
        use :: fassert_common_compare_approx_array
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real64_rank3_msg
        use :: expectSameShape
        use :: fassert_common_compare_approx_array
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real128_rank1_msg
        use :: expectSameShape
        use :: fassert_common_compare_approx_array
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real128_rank2_msg
        use :: expectSameShape
        use :: fassert_common_compare_approx_array
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approx_equal_real128_rank3_msg
        use :: expectSameShape
        use :: fassert_common_compare_approx_array
        implicit none
        ...
        if (is_verbose_output(stat, verbose, quiet)) call output_on_failure(actual, expected, output_message)
    end procedure expect_approx_equal_real128_rank3_msg

end submodule expectApproxEqualMsg_real_implementaion
