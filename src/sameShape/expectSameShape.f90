module expectSameShape
    ...
    interface expect_same_shape
        ...
        procedure :: expect_same_shape_rank1_msg
        procedure :: expect_same_shape_rank2_msg
        procedure :: expect_same_shape_rank3_msg
    end interface
    ...
    interface
        ...
        pure module subroutine expect_same_shape_rank1_msg(actual, expected, test_name, stat, &
            ...
            character(:), allocatable, intent(out) :: output_message
                !! 出力を格納する文字列
        end subroutine expect_same_shape_rank1_msg
        ...
        pure module subroutine expect_same_shape_rank2_msg(actual, expected, test_name, stat, &
            ...
            character(:), allocatable, intent(out) :: output_message
                !! 出力を格納する文字列
        end subroutine expect_same_shape_rank2_msg
        ...
        pure module subroutine expect_same_shape_rank3_msg(actual, expected, test_name, stat, &
            ...
            character(:), allocatable, intent(out) :: output_message
                !! 出力を格納する文字列
        end subroutine expect_same_shape_rank3_msg
    end interface
