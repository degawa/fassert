submodule(expectCharEqual) expectCharEqual_implementaion
contains
    ...
    !>
    module procedure expect_char_equal_
    ...
    end procedure expect_char_equal_
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_char_equal_rank1
        use :: fassert_common_check
        implicit none
        logical :: is_same_string
        logical :: case_insensitive
        ...
        if (is_verbose_output(stat, verbose, quiet)) call output_on_failure(actual, expected)
    end procedure expect_char_equal_rank1
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_char_equal_rank2
        use :: fassert_common_check
        implicit none
        logical :: is_same_string
        logical :: case_insensitive
        ...
        if (is_verbose_output(stat, verbose, quiet)) call output_on_failure(actual, expected)
    end procedure expect_char_equal_rank2
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_char_equal_rank3
        use :: fassert_common_check
        implicit none
        logical :: is_same_string
        logical :: case_insensitive
        ...
        if (is_verbose_output(stat, verbose, quiet)) call output_on_failure(actual, expected)
    end procedure expect_char_equal_rank3
end submodule expectCharEqual_implementaion
