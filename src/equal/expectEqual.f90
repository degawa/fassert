module expectEqual
    ...
    interface expect_equal
        ...
        procedure :: expect_equal_real32
        procedure :: expect_equal_real64
        procedure :: expect_equal_real128
        procedure :: expect_equal_complex32
        procedure :: expect_equal_complex64
        procedure :: expect_equal_complex128
        procedure :: expect_equal_real32_rank1
        procedure :: expect_equal_real64_rank1
        procedure :: expect_equal_real128_rank1
        procedure :: expect_equal_complex32_rank1
        procedure :: expect_equal_complex64_rank1
        procedure :: expect_equal_complex128_rank1
        procedure :: expect_equal_real32_rank2
        procedure :: expect_equal_real64_rank2
        procedure :: expect_equal_real128_rank2
        procedure :: expect_equal_complex32_rank2
        procedure :: expect_equal_complex64_rank2
        procedure :: expect_equal_complex128_rank2
        procedure :: expect_equal_real32_rank3
        procedure :: expect_equal_real64_rank3
        procedure :: expect_equal_real128_rank3
        procedure :: expect_equal_complex32_rank3
        procedure :: expect_equal_complex64_rank3
        procedure :: expect_equal_complex128_rank3
        ...
        procedure :: expect_equal_real32_msg
        procedure :: expect_equal_real64_msg
        procedure :: expect_equal_real128_msg
        procedure :: expect_equal_complex32_msg
        procedure :: expect_equal_complex64_msg
        procedure :: expect_equal_complex128_msg
        procedure :: expect_equal_real32_rank1_msg
        procedure :: expect_equal_real64_rank1_msg
        procedure :: expect_equal_real128_rank1_msg
        procedure :: expect_equal_complex32_rank1_msg
        procedure :: expect_equal_complex64_rank1_msg
        procedure :: expect_equal_complex128_rank1_msg
        procedure :: expect_equal_real32_rank2_msg
        procedure :: expect_equal_real64_rank2_msg
        procedure :: expect_equal_real128_rank2_msg
        procedure :: expect_equal_complex32_rank2_msg
        procedure :: expect_equal_complex64_rank2_msg
        procedure :: expect_equal_complex128_rank2_msg
        procedure :: expect_equal_real32_rank3_msg
        procedure :: expect_equal_real64_rank3_msg
        procedure :: expect_equal_real128_rank3_msg
        procedure :: expect_equal_complex32_rank3_msg
        procedure :: expect_equal_complex64_rank3_msg
        procedure :: expect_equal_complex128_rank3_msg
    ...
    interface
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real32(actual, expected, test_name, stat, &
                                              verbose, expected_failure, quiet)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real64(actual, expected, test_name, stat, &
                                              verbose, expected_failure, quiet)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real128(actual, expected, test_name, stat, &
                                               verbose, expected_failure, quiet)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real32_rank1(actual, expected, test_name, stat, &
                                                    verbose, expected_failure, quiet)
            real(real32), intent(in) :: actual(:)
                !! 実測値
            real(real32), intent(in) :: expected(:)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real32_rank2(actual, expected, test_name, stat, &
                                                    verbose, expected_failure, quiet)
            real(real32), intent(in) :: actual(:, :)
                !! 実測値
            real(real32), intent(in) :: expected(:, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real32_rank3(actual, expected, test_name, stat, &
                                                    verbose, expected_failure, quiet)
            real(real32), intent(in) :: actual(:, :, :)
                !! 実測値
            real(real32), intent(in) :: expected(:, :, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real64_rank1(actual, expected, test_name, stat, &
                                                    verbose, expected_failure, quiet)
            real(real64), intent(in) :: actual(:)
                !! 実測値
            real(real64), intent(in) :: expected(:)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real64_rank2(actual, expected, test_name, stat, &
                                                    verbose, expected_failure, quiet)
            real(real64), intent(in) :: actual(:, :)
                !! 実測値
            real(real64), intent(in) :: expected(:, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real64_rank3(actual, expected, test_name, stat, &
                                                    verbose, expected_failure, quiet)
            real(real64), intent(in) :: actual(:, :, :)
                !! 実測値
            real(real64), intent(in) :: expected(:, :, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real128_rank1(actual, expected, test_name, stat, &
                                                     verbose, expected_failure, quiet)
            real(real128), intent(in) :: actual(:)
                !! 実測値
            real(real128), intent(in) :: expected(:)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real128_rank2(actual, expected, test_name, stat, &
                                                     verbose, expected_failure, quiet)
            real(real128), intent(in) :: actual(:, :)
                !! 実測値
            real(real128), intent(in) :: expected(:, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_real128_rank3(actual, expected, test_name, stat, &
                                                     verbose, expected_failure, quiet)
            real(real128), intent(in) :: actual(:, :, :)
                !! 実測値
            real(real128), intent(in) :: expected(:, :, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex32(actual, expected, test_name, stat, &
                                                 verbose, expected_failure, quiet)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex64(actual, expected, test_name, stat, &
                                                 verbose, expected_failure, quiet)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex128(actual, expected, test_name, stat, &
                                                  verbose, expected_failure, quiet)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex32_rank1(actual, expected, test_name, stat, &
                                                       verbose, expected_failure, quiet)
            complex(real32), intent(in) :: actual(:)
                !! 実測値
            complex(real32), intent(in) :: expected(:)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex32_rank2(actual, expected, test_name, stat, &
                                                       verbose, expected_failure, quiet)
            complex(real32), intent(in) :: actual(:, :)
                !! 実測値
            complex(real32), intent(in) :: expected(:, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex32_rank3(actual, expected, test_name, stat, &
                                                       verbose, expected_failure, quiet)
            complex(real32), intent(in) :: actual(:, :, :)
                !! 実測値
            complex(real32), intent(in) :: expected(:, :, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex64_rank1(actual, expected, test_name, stat, &
                                                       verbose, expected_failure, quiet)
            complex(real64), intent(in) :: actual(:)
                !! 実測値
            complex(real64), intent(in) :: expected(:)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex64_rank2(actual, expected, test_name, stat, &
                                                       verbose, expected_failure, quiet)
            complex(real64), intent(in) :: actual(:, :)
                !! 実測値
            complex(real64), intent(in) :: expected(:, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex64_rank3(actual, expected, test_name, stat, &
                                                       verbose, expected_failure, quiet)
            complex(real64), intent(in) :: actual(:, :, :)
                !! 実測値
            complex(real64), intent(in) :: expected(:, :, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex128_rank1(actual, expected, test_name, stat, &
                                                        verbose, expected_failure, quiet)
            complex(real128), intent(in) :: actual(:)
                !! 実測値
            complex(real128), intent(in) :: expected(:)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex128_rank2(actual, expected, test_name, stat, &
                                                        verbose, expected_failure, quiet)
            complex(real128), intent(in) :: actual(:, :)
                !! 実測値
            complex(real128), intent(in) :: expected(:, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equal_complex128_rank3(actual, expected, test_name, stat, &
                                                        verbose, expected_failure, quiet)
            complex(real128), intent(in) :: actual(:, :, :)
                !! 実測値
            complex(real128), intent(in) :: expected(:, :, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equiv_logical_rank1(actual, expected, test_name, stat, &
                                                     verbose, expected_failure, quiet)
            logical, intent(in) :: actual(:)
                !! 実測値
            logical, intent(in) :: expected(:)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equiv_logical_rank2(actual, expected, test_name, stat, &
                                                     verbose, expected_failure, quiet)
            logical, intent(in) :: actual(:, :)
                !! 実測値
            logical, intent(in) :: expected(:, :)
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        module subroutine expect_equiv_logical_rank3(actual, expected, test_name, stat, &
                                                     verbose, expected_failure, quiet)
            logical, intent(in) :: actual(:, :, :)
                !! 実測値
            logical, intent(in) :: expected(:, :, :)
    ...
    interface
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real32_msg(actual, expected, test_name, stat, &
                                                       verbose, expected_failure, quiet, &
                                                       output_message)
            real(real32), intent(in) :: actual
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real64_msg(actual, expected, test_name, stat, &
                                                       verbose, expected_failure, quiet, &
                                                       output_message)
            real(real64), intent(in) :: actual
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real128_msg(actual, expected, test_name, stat, &
                                                        verbose, expected_failure, quiet, &
                                                        output_message)
            real(real128), intent(in) :: actual
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real32_rank1_msg(actual, expected, test_name, stat, &
                                                             verbose, expected_failure, quiet, &
                                                             output_message)
            real(real32), intent(in) :: actual(:)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real32_rank2_msg(actual, expected, test_name, stat, &
                                                             verbose, expected_failure, quiet, &
                                                             output_message)
            real(real32), intent(in) :: actual(:, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real32_rank3_msg(actual, expected, test_name, stat, &
                                                             verbose, expected_failure, quiet, &
                                                             output_message)
            real(real32), intent(in) :: actual(:, :, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real64_rank1_msg(actual, expected, test_name, stat, &
                                                             verbose, expected_failure, quiet, &
                                                             output_message)
            real(real64), intent(in) :: actual(:)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real64_rank2_msg(actual, expected, test_name, stat, &
                                                             verbose, expected_failure, quiet, &
                                                             output_message)
            real(real64), intent(in) :: actual(:, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real64_rank3_msg(actual, expected, test_name, stat, &
                                                             verbose, expected_failure, quiet, &
                                                             output_message)
            real(real64), intent(in) :: actual(:, :, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real128_rank1_msg(actual, expected, test_name, stat, &
                                                              verbose, expected_failure, quiet, &
                                                              output_message)
            real(real128), intent(in) :: actual(:)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real128_rank2_msg(actual, expected, test_name, stat, &
                                                              verbose, expected_failure, quiet, &
                                                              output_message)
            real(real128), intent(in) :: actual(:, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_real128_rank3_msg(actual, expected, test_name, stat, &
                                                              verbose, expected_failure, quiet, &
                                                              output_message)
            real(real128), intent(in) :: actual(:, :, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex32_msg(actual, expected, test_name, stat, &
                                                          verbose, expected_failure, quiet, &
                                                          output_message)
            complex(real32), intent(in) :: actual
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex64_msg(actual, expected, test_name, stat, &
                                                          verbose, expected_failure, quiet, &
                                                          output_message)
            complex(real64), intent(in) :: actual
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex128_msg(actual, expected, test_name, stat, &
                                                           verbose, expected_failure, quiet, &
                                                           output_message)
            complex(real128), intent(in) :: actual
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex32_rank1_msg(actual, expected, test_name, stat, &
                                                                verbose, expected_failure, quiet, &
                                                                output_message)
            complex(real32), intent(in) :: actual(:)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex32_rank2_msg(actual, expected, test_name, stat, &
                                                                verbose, expected_failure, quiet, &
                                                                output_message)
            complex(real32), intent(in) :: actual(:, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex32_rank3_msg(actual, expected, test_name, stat, &
                                                                verbose, expected_failure, quiet, &
                                                                output_message)
            complex(real32), intent(in) :: actual(:, :, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex64_rank1_msg(actual, expected, test_name, stat, &
                                                                verbose, expected_failure, quiet, &
                                                                output_message)
            complex(real64), intent(in) :: actual(:)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex64_rank2_msg(actual, expected, test_name, stat, &
                                                                verbose, expected_failure, quiet, &
                                                                output_message)
            complex(real64), intent(in) :: actual(:, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex64_rank3_msg(actual, expected, test_name, stat, &
                                                                verbose, expected_failure, quiet, &
                                                                output_message)
            complex(real64), intent(in) :: actual(:, :, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex128_rank1_msg(actual, expected, test_name, stat, &
                                                                 verbose, expected_failure, quiet, &
                                                                 output_message)
            complex(real128), intent(in) :: actual(:)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex128_rank2_msg(actual, expected, test_name, stat, &
                                                                 verbose, expected_failure, quiet, &
                                                                 output_message)
            complex(real128), intent(in) :: actual(:, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equal_complex128_rank3_msg(actual, expected, test_name, stat, &
                                                                 verbose, expected_failure, quiet, &
                                                                 output_message)
            complex(real128), intent(in) :: actual(:, :, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equiv_logical_rank1_msg(actual, expected, test_name, stat, &
                                                              verbose, expected_failure, quiet, &
                                                              output_message)
            logical, intent(in) :: actual(:)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equiv_logical_rank2_msg(actual, expected, test_name, stat, &
                                                              verbose, expected_failure, quiet, &
                                                              output_message)
            logical, intent(in) :: actual(:, :)
                !! 実測値
        ...
        !>`quiet`が真の場合，成功時の出力を抑制する．
        !>
        pure module subroutine expect_equiv_logical_rank3_msg(actual, expected, test_name, stat, &
                                                              verbose, expected_failure, quiet, &
                                                              output_message)
            logical, intent(in) :: actual(:, :, :)
                !! 実測値
