module assertEqual
    ...
    interface assert_equal
        ...
        procedure :: assert_equal_int8_rank1
        procedure :: assert_equal_int16_rank1
        procedure :: assert_equal_int32_rank1
        procedure :: assert_equal_int64_rank1
        procedure :: assert_equal_int8_rank2
        procedure :: assert_equal_int16_rank2
        procedure :: assert_equal_int32_rank2
        procedure :: assert_equal_int64_rank2
        procedure :: assert_equal_int8_rank3
...
contains
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int8_rank1(actual, expected, test_name, &
                                       verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int8_rank2(actual, expected, test_name, &
                                       verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int8_rank3(actual, expected, test_name, &
                                       verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int16_rank1(actual, expected, test_name, &
                                        verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int16_rank2(actual, expected, test_name, &
                                        verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int16_rank3(actual, expected, test_name, &
                                        verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int64_rank1(actual, expected, test_name, &
                                        verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int64_rank2(actual, expected, test_name, &
                                        verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equal_int64_rank3(actual, expected, test_name, &
                                        verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equiv_logical_rank1(actual, expected, test_name, &
                                          verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equiv_logical_rank2(actual, expected, test_name, &
                                          verbose, expected_failure, quiet)
        implicit none
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    subroutine assert_equiv_logical_rank3(actual, expected, test_name, &
                                          verbose, expected_failure, quiet)
        implicit none
