...
contains
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approxequal_real128_msg
        use :: fassert_common_compare_equal_real
        implicit none
        ...
        if (is_verbose_output(stat, verbose, quiet)) call output_on_failure(actual, expected, output_message)
    end procedure expect_approxequal_real128_msg
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approxequal_real128_rank1_msg
        use :: expectSameShape
        use :: fassert_common_compare_equal_array
        implicit none
        ...
        if (is_verbose_output(stat, verbose, quiet)) call output_on_failure(actual, expected, output_message)
    end procedure expect_approxequal_real128_rank1_msg
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approxequal_real128_rank2_msg
        use :: expectSameShape
        use :: fassert_common_compare_equal_array
        implicit none
        ...
        if (is_verbose_output(stat, verbose, quiet)) call output_on_failure(actual, expected, output_message)
    end procedure expect_approxequal_real128_rank2_msg
    ...
    !>`quiet`が真の場合，成功時の出力を抑制する．
    !>
    module procedure expect_approxequal_real128_rank3_msg
        use :: expectSameShape
        use :: fassert_common_compare_equal_array
        implicit none
        ...
        if (is_verbose_output(stat, verbose, quiet)) call output_on_failure(actual, expected, output_message)
    end procedure expect_approxequal_real128_rank3_msg
