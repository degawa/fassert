module test_sameType_expectSameType_unitTests_expect_common
    ...
    type, public :: a_parent_type
    end type a_parent_type

    type, public, extends(a_parent_type) :: an_extended_type
    end type an_extended_type

    type, public, extends(a_parent_type) :: another_extended_type
...
end module test_sameType_expectSameType_unitTests_expect_common
