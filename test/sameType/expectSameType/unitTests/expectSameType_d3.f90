module test_sameType_expectSameType_unitTests_expect_D3
    ...
    implicit none
    private
    public :: expect_same_type_d3_tests_success_cases
    public :: expect_same_type_d3_tests_failure_cases
    public :: expect_same_type_d3_tests_expected_failure_cases

contains
    subroutine expect_same_type_d3_tests_success_cases(error)
        implicit none
        ...
        type(a_parent_type) :: p_1(1, 2, 1), p_2(1, 2, 3)
        type(an_extended_type) :: e1_1(2, 1, 1), e1_2(1, 5, 1)
        type(another_extended_type) :: e2_1(1, 1, 3), e2_2(2, 1, 2)
        ...
        if (occurred(error)) return
        call after_all()
    end subroutine expect_same_type_d3_tests_success_cases

    subroutine expect_same_type_d3_tests_failure_cases(error)
        implicit none
        type(error_type), allocatable, intent(out) :: error
        ...
        call after_all()
    end subroutine expect_same_type_d3_tests_failure_cases

    subroutine expect_same_type_d3_tests_expected_failure_cases(error)
        implicit none
        type(error_type), allocatable, intent(out) :: error
        ...
        call after_all()
    end subroutine expect_same_type_d3_tests_expected_failure_cases
end module test_sameType_expectSameType_unitTests_expect_D3
