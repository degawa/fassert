module test_sameType_expectSameType_unitTests_expect_D1
    ...
    implicit none
    private
    public :: expect_same_type_d1_tests_success_cases
    public :: expect_same_type_d1_tests_failure_cases
    public :: expect_same_type_d1_tests_expected_failure_cases

contains
    subroutine expect_same_type_d1_tests_success_cases(error)
        implicit none
        ...
        type(a_parent_type) :: p_1(1), p_2(6)
        type(an_extended_type) :: e1_1(2), e1_2(5)
        type(another_extended_type) :: e2_1(3), e2_2(4)
        ...
        if (occurred(error)) return
        call after_all()
    end subroutine expect_same_type_d1_tests_success_cases

    subroutine expect_same_type_d1_tests_failure_cases(error)
        implicit none
        type(error_type), allocatable, intent(out) :: error
        ...
        call after_all()
    end subroutine expect_same_type_d1_tests_failure_cases

    subroutine expect_same_type_d1_tests_expected_failure_cases(error)
        implicit none
        type(error_type), allocatable, intent(out) :: error
        ...
        call after_all()
    end subroutine expect_same_type_d1_tests_expected_failure_cases
end module test_sameType_expectSameType_unitTests_expect_D1
