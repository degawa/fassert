module test_logical_expectFalse_unitTests_expectFalseExpectedFailure
    ...
    private
    !T: true, F: false
    public :: expectFalse_expected_failure_F_parameterized_test
    public :: expectFalse_expected_failure_T_parameterized_test

contains
    subroutine expectFalse_expected_failure_F_parameterized_test(error)
        implicit none
    ...
    end subroutine expectFalse_expected_failure_F_parameterized_test

    subroutine expectFalse_expected_failure_T_parameterized_test(error)
        implicit none
        type(error_type), allocatable, intent(out) :: error
            !! error handler
        ...
        spec = new_parameterization_spec( &
               ...
               , new_test_parameter(arguments="actual=true test_name='a unit test' verbose=true "// &
                                    "expected_failure=true", &
                                    expected="message='"// &
                                    "PASSED: a unit test [expected failure]"//new_line_char// &
               ...
               , new_test_parameter(arguments="actual=false test_name='a unit test' "// &
                                    "expected_failure=true", &
                                    expected="message='"// &
                                    "FAILED: a unit test [unexpected pass]"//new_line_char// &
                                    "    Expected: T"//new_line_char// &
    ...
    end subroutine expectFalse_expected_failure_T_parameterized_test
end module test_logical_expectFalse_unitTests_expectFalseExpectedFailure
