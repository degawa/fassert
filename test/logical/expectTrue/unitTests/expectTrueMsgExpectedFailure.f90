module test_logical_expectTrue_unitTests_expectTrueExpectedFailureMsg
    ...
    private
    !T: true, F: false
    public :: expectTrueMsg_expected_failure_F_parameterized_test
    public :: expectTrueMsg_expected_failure_T_parameterized_test

contains
    subroutine expectTrueMsg_expected_failure_F_parameterized_test(error)
        implicit none
    ...
    end subroutine expectTrueMsg_expected_failure_F_parameterized_test

    subroutine expectTrueMsg_expected_failure_T_parameterized_test(error)
        use :: par_funnel
        implicit none
        type(error_type), allocatable, intent(out) :: error
            !! error handler
    ...
    end subroutine expectTrueMsg_expected_failure_T_parameterized_test
end module test_logical_expectTrue_unitTests_expectTrueExpectedFailureMsg
