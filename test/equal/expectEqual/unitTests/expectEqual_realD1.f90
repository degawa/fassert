module test_equal_expectEqual_unitTests_expect_realD1
    ...
    implicit none
    private
    public :: expectEqual_realD1_parameterized_test

contains
    subroutine expectEqual_realD1_parameterized_test(error)
        implicit none
        ...
        spec = new_parameterization_spec( &
               ...
               new_test_parameter(arguments="vtype='real32' size=3 val_act='1.0,2.0,3.0' val_exp='1.0,2.0,3.0' "// &
               ...
               , new_test_parameter(arguments="vtype='real32' size=3 val_act='1.0,2.0,3.0' val_exp='1.0,2.0,3.0' "// &
                                    ...
                                    "    Maximum Absolute Difference:  0.000000E+00 at (1)"//new_line_char// &
                                    "    Minimum Absolute Difference:  0.000000E+00 at (1)' stat_exp=true") &
               ...
               , new_test_parameter(arguments="vtype='real32' size=3 val_act='1.0,2.0,3.0' val_exp='1.0,2.0,-3.0' "// &
                                    ...
                                    "    Maximum Absolute Difference:  0.600000E+01 at (3)"//new_line_char// &
                                    "    Minimum Absolute Difference:  0.000000E+00 at (1)' stat_exp=false") &
               !-v expect_equal(actual,expected,name,stat,verbose=F)
               , new_test_parameter(arguments="vtype='real32' size=3 val_act='1.0,2.0,3.0' val_exp='1.0,2.0,-3.0' "// &
                                    "test_name='a unit test' verbose=false", &
                                    expected="message='"// &
               ...
               !v success cases
               !-v expect_equal(actual,expected,name,stat)
               , new_test_parameter(arguments="vtype='real64' size=3 val_act='1.0,2.0,3.0' val_exp='1.0,2.0,3.0' "// &
                                    "test_name='a unit test'", &
                                    expected="message='PASSED: a unit test' stat_exp=true") &
               !-v expect_equal(actual,expected,name,stat,verbose=F)
               , new_test_parameter(arguments="vtype='real64' size=3 val_act='1.0,2.0,3.0' val_exp='1.0,2.0,3.0' "// &
               ...
               , new_test_parameter(arguments="vtype='real64' size=3 val_act='1.0,2.0,3.0' val_exp='1.0,2.0,3.0' "// &
                                    ...
                                    expected="message='"// &
                                    "PASSED: a unit test"//new_line_char// &
                                    "    Maximum Absolute Difference:  0.000000000000000E+000 at (1)"//new_line_char// &
                                    "    Minimum Absolute Difference:  0.000000000000000E+000 at (1)' stat_exp=true") &
               !-v expect_equal(actual,expected,name,stat,verbose=T, quiet=F)
               , new_test_parameter(arguments="vtype='real64' size=3 val_act='1.0,2.0,3.0' val_exp='1.0,2.0,3.0' "// &
                                    "test_name='a unit test' verbose=true quiet=false", &
                                    expected="message='"// &
               ...
               , new_test_parameter(arguments="vtype='real64' size=3 val_act='1.0,2.0,3.0' val_exp='-1.0,2.0,3.0' "// &
                                    ...
                                    expected="message='"// &
                                    "FAILED: a unit test"//new_line_char// &
                                    "    Maximum Absolute Difference:  0.200000000000000E+001 at (1)"//new_line_char// &
                                    "    Minimum Absolute Difference:  0.000000000000000E+000 at (2)' stat_exp=false") &
               !-v expect_equal(actual,expected,name,stat,verbose=F)
               , new_test_parameter(arguments="vtype='real64' size=3 val_act='1.0,2.0,3.0' val_exp='-1.0,2.0,3.0' "// &
                                    "test_name='a unit test' verbose=false", &
                                    expected="message='"// &
    ...
    end subroutine expectEqual_realD1_parameterized_test
end module test_equal_expectEqual_unitTests_expect_realD1
