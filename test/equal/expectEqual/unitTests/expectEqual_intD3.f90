module test_equal_expectEqual_unitTests_expect_intD3
    ...
    implicit none
    private
    public :: expectEqual_intD3_parameterized_test

contains
    subroutine expectEqual_intD3_parameterized_test(error)
        implicit none
        ...
        spec = new_parameterization_spec( &
               ...
               new_test_parameter(arguments="vtype='int32' size=3,2,1 val_act='1,2,3,4,5,6' val_exp='1,2,3,4,5,6' "// &
               ...
               , new_test_parameter(arguments="vtype='int32' size=3,2,1 val_act='1,2,3,4,5,6' val_exp='1,2,3,4,5,6' "// &
                                    ...
                                    "    Maximum Absolute Difference: 0 at (1,1,1)"//new_line_char// &
                                    "    Minimum Absolute Difference: 0 at (1,1,1)' stat_exp=true") &
               ...
               , new_test_parameter(arguments="vtype='int32' size=3,2,1 val_act='1,2,3,4,5,6' val_exp='1,-2,3,4,-5,6' "// &
                                    ...
                                    "    Maximum Absolute Difference: 10 at (2,2,1)"//new_line_char// &
                                    "    Minimum Absolute Difference: 0 at (1,1,1)' stat_exp=false") &
               !-v expect_equal(actual,expected,name,stat,verbose=F)
               , new_test_parameter(arguments="vtype='int32' size=3,2,1 val_act='1,2,3,4,5,6' val_exp='1,-2,3,4,-5,6' "// &
                                    "test_name='a unit test' verbose=false", &
                                    expected="message='"// &
        ...
        subroutine run_test_cases(spec, results)
            ...
            block
                ...
                do case = 1, results%get_number_of_test_cases()
                    ...
                    case ("int32")
                        block
                            integer(int32), allocatable :: act(:, :, :), exp(:, :, :)
    ...
    end subroutine expectEqual_intD3_parameterized_test
end module test_equal_expectEqual_unitTests_expect_intD3
